...
const routes = [
  ...
  { href: "/checker", label: "8021 Checker" },
];
  ...
  return (
    <div className="chrome">
      <div className="chrome-inner">
        <span className="chrome-label">Builder Code Integration &amp; Verification</span>
